...
namespace TowerRpg.Core
{
    ...
    public sealed class BalanceConfig : MonoBehaviour
    {
        ...
        private static readonly string[] RequiredKeys =
        {
            ...
            "tower.floorsPerChapter", "tower.bossEvery", "boss.hpMult1",
            "boss.hpMult2", "boss.hpMult3", "boss.hpMult4",
            "boss.hpMult5", "boss.hpMult6", "boss.hpMult7",
            "boss.hpMult8", "boss.hpMult9", "boss.hpMult10",
            "boss.count", "boss.attackRangeMult", "character.k0",
            "character.k1", "character.k2", "character.k3",
            "character.k4", "core.perBoss", "core.gate1",
            "core.gate2", "core.gate3", "core.gate4",
            "core.gate5", "core.capStep", "respec.costBase",
            "respec.costGrowth", "sweep.unlockOnClear", "sweep.seconds",
            "sweep.totalMult", "auto.unlockFloor", "juice.shakeDuration",
            "juice.shakeMagnitude", "juice.shakeYRatio", "juice.popupRiseSpeed",
            "juice.popupLifetime", "juice.enemyDeathSeconds", "juice.healthBarHideAbove",
            "juice.popupDecimalBelow", "audio.sfxVolume", "audio.playerHitCooldown",
            "loot.popDistance", "loot.popSeconds", "loot.magnetRadius",
            "loot.pickupRadius", "loot.flySpeed", "loot.maxLifetime",
